...
c.NotebookApp.allow_origin = u'tdi_project.herokuapp.com' # put your public IP Address here
c.NotebookApp.ip = '*'
c.NotebookApp.allow_remote_access = True
c.NotebookApp.open_browser = False

# ipython -c "from notebook.auth import passwd; passwd()"
c.NotebookApp.password = u'argon2:$argon2id$v=19$m=10240,t=10,p=8$JOSdxEs/t/uqiNmGwxUldw$ZqNDOuJgkjmVX3Wch7b7yw'
